<div class="container">
	<div class="row">
		<div class="col-sm-7">
			<video poster="{{secure_asset('video/video-poster.jpg')}}" controls preload="none" class="video lozad" data-src="{{secure_asset('video/bag-video.mp4')}}" type="video/mp4"id="video"></video>
		</div>
		<div class="col-sm-5">
